...
Over 35 published books, specializing in storyboarding, character design, animal illustration, whimsical cartoon style, and book cover design.

Full-service illustration packages including consultation, tailored character development, and flexible revisions.

**Ghostwriting**

Authored the book God Was Holding My Hand.

Specialize in memoirs, articles, ebooks, and books across various genres, with a focus on personal growth, self-help, and transformation.

**Creative Writing & Presentation Design**

Expert in designing minimalist, modern presentations with a focus on investor pitch decks, corporate presentations, sales decks, and more.

Services include template design, infographic & data visualization, and creative direction.

**Wix Website Design**

Skilled in creating custom Wix websites tailored to client branding and business goals.
...
Description: A whimsical, narrative-driven children's book featuring forest animals on an adventure. The project included creating lovable animal characters and immersive settings that brought the story to life. The book was published with both print and digital formats.

Role: Full-book illustration, including character design, animal illustrations, and the book cover.
...
Description: A deeply personal memoir that chronicles life experiences and the transformative power of faith. The book integrates motivational insights with storytelling to inspire others on their journey.

Role: Full manuscript creation, editing, and proofreading.
...
Description: Designed a sleek, modern investor pitch deck that clearly communicated the startup's value proposition, market strategy, and potential for growth. The deck included custom infographics and data visualizations.
...
Role: Full website design, SEO setup, and e-commerce configuration.
...
Initial Sample
I create a sample to set the visual tone before full development.
